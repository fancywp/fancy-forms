...
class FancyFormsFieldHeading extends FancyFormsFieldType {
    ...
    protected function input_html() {
        ...
        ?>
        <<?php echo (isset($field['heading_type']) ? esc_attr($field['heading_type']) : 'h1'); ?> class="fancyforms-heading-field" id="fancyforms-field-<?php echo esc_attr($field['id']); ?>">
