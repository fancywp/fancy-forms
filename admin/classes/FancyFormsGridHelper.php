...
class FancyFormsGridHelper {
    ...
    private function begin_field_wrapper() {
        echo '<li class="fancyforms-editor-field-box"><ul class="fancyforms-editor-grid-container fancyforms-editor-sorting">';
        $this->parent_li = true;
        $this->current_list_size = 0;
        $this->current_field_count = 0;
    }
    ...
    private static function get_size_of_class($class) {
        if (0 === strpos($class, 'fancyforms-grid-')) {
