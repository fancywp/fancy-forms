...
<div class="fancyforms-form-container fancyforms-grid-container">
    <div class="fancyforms-form-row">
        <div class="fancyforms-condition-repeater-blocks">
            <?php
            $conditional_logics = FancyFormsBuilder::get_show_hide_conditions($id);
            foreach ($conditional_logics as $key => $row) {
                ...
                <div class="fancyforms-condition-repeater-block">
                    ...
                    <span class="fancyforms-condition-seperator">if</span>
        ...
        <button class="fancyforms-add-more-condition"><span class="mdi mdi-plus"></span><?php echo esc_html__('Add Condition', 'fancy-forms'); ?></button>
    </div>
</div>