...
function fancyforms_sanitize_checkbox($input) {
    if ($input == 'on') {
        return 'on';
    } else {
        return 'off';
...
function fancyforms_sanitize_number($input) {
    if (is_numeric($input)) {
        return intval($input);
    } else {
        return '';
...
function fancyforms_sanitize_float($input) {
    if (is_numeric($input)) {
        return (float) $input;
    } else {
        return '';
...
function fancyforms_sanitize_color($color) {
...
function fancyforms_sanitize_url($url) {
    $sanitized_url = strip_tags(stripslashes(filter_var($url, FILTER_VALIDATE_URL)));
    return $sanitized_url;
}

function fancyforms_sanitize_checkbox_boolean($input) {
    if (true == $input) {
        return true;
    } else {
        return false;
...
function fancyforms_sanitize_allowed_file_extensions($extensions) {
