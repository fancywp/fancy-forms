...
qq.extend(qq.FileUploader.prototype, {
    ...
    _onComplete: function (id, fileName, result) {
        ...
        jQuery(item).append('<span class="fancyforms-preview-remove" data-path="' + result.path + '" data-remove-id="fancyforms-uploaded-' + id + '">' + fancyforms_file_vars.remove_txt + '</span></div>');
    },
